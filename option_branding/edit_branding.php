      	...
      	<div class="container">
      		<div class="col-md-12">
      			<div class="card">
		      		...
		      		<div class="card-body">
		      			<form action="update_branding.php" method="POST" enctype="multipart/form-data">
									<div class="mb-3">
									    <label for="title" class="form-label">Brand Name</label>
									    <input value="<?= $after_assoc['id']; ?>" name="id" type="hidden">
									    <input value="<?= $after_assoc['brand_name']; ?>" name="brand_name" type="text" class="form-control" id="title">
									</div>
									<div class="mb-3">
										<label for="img" class="form-label d-block pt-2">Brand Image</label>
										<img src="uploaded/<?= $after_assoc['brand_image']; ?>" width="200" class="img-fluid mb-3">
