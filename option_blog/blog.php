...
$blog_assoc = mysqli_fetch_assoc($select_blogs_query);

//News Section
$select_news = "SELECT * FROM blogs WHERE id !=$id ORDER BY id DESC LIMIT 3";
$select_news_query = mysqli_query($db_connect, $select_news);
?>
   ...
   <div class="click-capture d-lg-none"></div>
    ...
    <nav id="scrollspy" class="navbar navbar-desctop">
      ...
      <div class="d-flex position-relative w-100">
        ...
        <!-- Brand-->
        <a class="navbar-brand" href="../index.php"><?= $after_assoc_logo['logo_text']; ?></a>
          ...
          <div class="col-md-10">
            <div class="card">
              <div class="card-header">
                <img src="uploaded/<?= $blog_assoc['blog_image']; ?>" class="w-100">
                <h1 style="font-size: 35px;" class="pt-3"><?= $blog_assoc['title']; ?></h1>
              </div>
              <div class="card-body">
                <p><?= $blog_assoc['des']; ?></p>
              </div>
     ...
     <div class="container">
        ...
        <div class="mt-5 pt-5">
          <div class="row-news row">
            ...
            <?php foreach($select_news_query as $news){ ?>
              <div class="col-news col-md-6 col-lg-4" data-aos="fade-in" data-aos-delay="0">
                <figure class="position-relative">
                  <div class="position-relative">
                    <a href=""><img alt="" class="w-100 d-block" src="uploaded/<?= $news['blog_image']; ?>"></a>
                    <mark class="date"><?= $news['posted_at']; ?></mark>
                  </div>
                  <figcaption><h5><a href="blog.php?id=<?= $news['id']; ?>"><?= $news['title']; ?></a></h5><?= substr($news['des'], 0, 50)."..." ?>
                  </figcaption>
                </figure>
              </div>
            <?php } ?>
