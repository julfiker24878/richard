   ...
   <div class="click-capture d-lg-none"></div>
    ...
    <nav id="scrollspy" class="navbar navbar-desctop">
      ...
      <div class="d-flex position-relative w-100">
        ...
        <!-- Brand-->
        <a class="navbar-brand" href="../index.php"><img src="/cit/richard/option_logo/uploaded/<?= $after_assoc_logo['logo_image']; ?>" width="100"><?= $after_assoc_logo['logo_text']; ?></a>
    ...
    <section id="news" class="section bg-light">
     <div class="container">
        <div class="row align-items-end">
          <div class="col-md-6" data-aos="fade-up"><h2 class="mb-3 mb-md-0">All Blog</h2></div>
        </div>
        <div class="mt-5 pt-5">
              ...
              <div class="col-news col-md-6 col-lg-4" data-aos="fade-in" data-aos-delay="0">
                <figure class="position-relative">
                  <div class="position-relative">
                    <a href=""><img alt="" class="w-100 d-block" src="uploaded/<?= $blog['blog_image']; ?>"></a>
                    <mark class="date"><?= $blog['posted_at']; ?></mark>
                  </div>
                  <figcaption><h5><a href="blog.php?id=<?= $blog['id']; ?>"><?= $blog['title']; ?></a></h5><?= substr($blog['des'], 0, 50)."..." ?>
                  </figcaption>
                </figure>
              </div>
            <?php } ?>
